...
const Landing = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: [
        "	زيادة الإنتاجية؛ حيث تساعد المبيدات في حماية المحاصيل من الآفات والأمراض .",
    ...
    },
    {
      ...
      answer: [
        ...
        "الأسمدة المعدنية (الكيميائية)هي أسمدة مصنعة من مركبات كيميائية تحتوي على العناصر الغذائية الأساسية مثل النيتروجين (N)، الفسفور (P)، والبوتاسيوم (K).",
        ...
        "تحتوي على عناصر غذائية ثانوية مثل الحديد (Fe)، المغنيسيوم (Mg)، الكبريت (S)، الزنك (Zn)، النحاس (Cu). وتستخدم بكميات صغيرة ولكنها مهمة لتحسين صحة النباتات وتحفيز عملية التمثيل الضوئي.",
        "تحتوي على العناصر الغذائية بشكل سائل، مما يجعل امتصاصها أسرع من الأسمدة الصلبة وتُستخدم في الري أو الرش على الأوراق.",
        ...
        <section className="about-section" id="about">
          ...
          <div className="container">
            ...
            <div className="about-txt">
              <h1>التأسيس</h1>
              <p>
              تأسست مؤسسة البركة في عام 1994، وبدأت مشوارها كشريك موثوق في القطاع الزراعي، ملتزمة بتلبية احتياجات المزارعين من خلال توفير منتجات عالية الجودة تشمل المبيدات الزراعية ، الأسمدة ، المخصبات والبذور. يقع مقرنا في مدينة بلقاس- محافظة الدقهلية- جمهورية مصر العربية. منذ البداية، كانت مهمتنا هي تقديم حلول زراعية مبتكرة ومتكاملة، بالإضافة إلى تقديم الإستشارات والدعم العملي للمزارعين لتحقيق أفضل نتائج في زراعتهم.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="vision-txt">
              <p>
                ...
                نسعى في مؤسسة البركة لأن نكون شريكًا موثوقًا في دعم الزراعة المستدامة من خلال تقديم حلول مبتكرة تُحسن الإنتاجية وتعزز الاستدامة. ونحن ملتزمون بتوفير أفضل المنتجات الزراعية التي تلبي احتياجات المزارعين وتدعمهم في تحقيق أقصى استفادة من مواردهم.
                <br />
                <br />
                <span className = "V-M">
                مهمتنا: 
                 </span> 
                 التركيز على المزارعين: نحن نؤمن بأن نجاح المزارعين هو نجاح لنا، ومن أجل ذلك نقدم لهم استشارات متخصصة ونحلل احتياجاتهم بدقة لتقديم أفضل الحلول الزراعية. "نحن هنا لدعمك في كل خطوة" .
                <br />
                الاستدامة والإنتاجية: نعمل على دعم الزراعة المستدامة من خلال توفير مبيدات زراعية ، أسمدة وتقاوي تحقق أعلى معدلات الإنتاجية والجودة. فإن مؤسسة البركة ليست مجرد مورد للمنتجات الزراعية، بل هي جزء من رؤية أكبر لدعم الزراعة المستدامة.
<br />
                التعاون المستمر:
                التعاون المستمر: نسعى لبناء علاقات شراكة طويلة الأمد مع المزارعين، حيث نكون دائمًا إلى جانبهم في كل خطوة على الطريق لتحقيق نجاحات ملموسة.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="about-section timeline">
          ...
          <div className="container">
            <div className="about-txt">
              <p>
                <span>1994:</span> تأسيس مؤسسة البركة وتوجهها لتلبية احتياجات المزارعين من خلال توفير المدخلات الزراعية الأساسية.
                <br />
                <span>2010:</span> إطلاق التقاوي كمنتج رئيسي ضمن محفظتنا، والمصممة لتحقيق أقصى استفادة من نمو المحاصيل وزيادة إنتاجيتها.
                <br />
                <span>2012:</span>  توسيع نشاطنا ليشمل استيراد المبيدات الزراعية والأسمدة والمخصبات عالية الجودة، وتقديم مجموعة متنوعة من الحلول الزراعية التي تساهم في مواجهة التحديات الزراعية.
              </p>
            </div>
            <div className="img-container">
